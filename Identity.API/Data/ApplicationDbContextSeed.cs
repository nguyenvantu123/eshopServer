...
namespace Identity.API.Data
{
    ...
    public class ApplicationDbContextSeed
    {
        ...
        internal object SeedAsync(ApplicationDbContext context, IEnumerable<IWebHostEnvironment> env, ILogger<ApplicationDbContextSeed> logger, IOptions<AppSettings> settings)
        {
